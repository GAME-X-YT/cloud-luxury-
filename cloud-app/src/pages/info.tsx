import { motion, type Variants, useScroll, useTransform } from 'framer-motion'; // Added useScroll, useTransform
...
const About = () => {
    ...
    // 2. Define the 'scale' variable (it grows from 1 to 1.1 as you scroll)
    ...
    return (
        ...
        <div ref={containerRef} className="min-h-screen bg-[#050505] text-white pt-32 px-6 overflow-hidden">
            ...
            <motion.div style={{ scale }} className="fixed inset-0 opacity-40 z-0">
                <img 
                    ...
                    alt="Hero background"
                />
                {/* Fixed the CSS class name here to gradient-to-b */}
